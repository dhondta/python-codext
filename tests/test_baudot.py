...
class TestCodecBaudot(TestCase):
    def test_codec_baudot(self):
        ...
        STR = "TEST 1234"
        ENC = {
            'ccitt1_lsb': "101010001010001101010100000100000100000100101",
            'ccitt2_lsb': "00001100001010000001001001101111101110011000001010",
            'fr':         "10101000101010010101100000100000001000100010000101",
    ...
    def test_codec_baudot_spaced(self):
        STR = "TEST 1234"
        ENC = {
            'ccitt1_lsb': "10101 00010 10001 10101 01000 00100 00010 00001 00101",
            'ccitt2_lsb': "00001 10000 10100 00001 00100 11011 11101 11001 10000 01010",
            'fr':         "10101 00010 10100 10101 10000 01000 00001 00010 00100 00101",
